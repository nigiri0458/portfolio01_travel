$(function() {
    ...
    $('.taiwan-container div').click(function() {
        $('.back').css('z-index', '20');
        $('.back').css('opacity', '1').css('transition', 'all 0.2s');
        $focus = $(this);
        $focus.css('z-index', '20');
        $focus.css('transform', 'scale(1.6, 1.6)').css('transition', 'all 0.2s');
    });
    $('.back').click(function() {
        $('.back').css('z-index', '0');
        $(this).css('opacity', '0').css('transition', 'all 0.2s');
        $focus.css('position', 'static').css('transform', 'scale(1, 1)').css('z-index', '5');
    });

    $('.la-container div').click(function() {
        $('.back').css('z-index', '20');
        $('.back').css('opacity', '1').css('transition', 'all 0.2s');
        $focus = $(this);
        $focus.css('z-index', '20');
    ...
    $('.thai-container div').click(function() {
        $('.back').css('z-index', '20');
        $('.back').css('opacity', '1').css('transition', 'all 0.2s');
        $focus = $(this);
        $focus.css('z-index', '20');
